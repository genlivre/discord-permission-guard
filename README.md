...
- **返信忘れ監視（Reply Monitor）**
  ...
  - 最終メッセージに **運営が ✅ リアクション**を付けると「対応不要」としてアラート対象外にできる
...
5. ただし最新メッセージに **運営が付けた ✅ リアクション**があればアラート対象外
   （返信不要で会話が終わっているケースの運用逃げ道。🙇 などその他のリアクションは返信とみなさない）
...
4. 429 発生時は `Retry-After` を尊重して 1 回リトライ
